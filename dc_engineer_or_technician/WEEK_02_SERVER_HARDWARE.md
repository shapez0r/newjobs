...
- [Part 1: Comprehensive Week 2 topics](#part-1-comprehensive-week-2-topics)
  ...
  - [2. Rack server anatomy](#2-rack-server-anatomy)
  - [3. CPU fundamentals](#3-cpu-fundamentals)
  - [4. RAM and ECC memory](#4-ram-and-ecc-memory)
  - [5. Motherboard, chipset, and PCIe](#5-motherboard-chipset-and-pcie)
  - [6. Power supplies and power path](#6-power-supplies-and-power-path)
  - [7. Storage devices](#7-storage-devices)
  - [8. RAID and HBA fundamentals](#8-raid-and-hba-fundamentals)
  - [9. Network interfaces and MAC addresses](#9-network-interfaces-and-mac-addresses)
  - [10. Hot-swappable components](#10-hot-swappable-components)
  - [11. Firmware, BIOS, and UEFI](#11-firmware-bios-and-uefi)
  - [12. Boot process](#12-boot-process)
  - [13. BMC, iDRAC, iLO, and IPMI](#13-bmc-idrac-ilo-and-ipmi)
  - [14. PXE boot and imaging basics](#14-pxe-boot-and-imaging-basics)
  - [15. Asset tags, serial numbers, service tags, and inventory](#15-asset-tags-serial-numbers-service-tags-and-inventory)
  - [16. Common hardware symptoms](#16-common-hardware-symptoms)
  - [17. Linux hardware inspection commands](#17-linux-hardware-inspection-commands)
  - [18. Evidence, ticket updates, and escalation](#18-evidence-ticket-updates-and-escalation)
- [Part 2: Week 2 questions and model answers](#part-2-week-2-questions-and-model-answers)
  - [Server fundamentals](#server-fundamentals)
  - [Components](#components)
  - [Storage and RAID](#storage-and-raid)
  - [Firmware, boot, and remote management](#firmware-boot-and-remote-management)
  - [Troubleshooting scenarios](#troubleshooting-scenarios)
  - [Documentation and professionalism](#documentation-and-professionalism)
- [Part 3: Lab exercises with hints](#part-3-lab-exercises-with-hints)
  - [Lab 1: Build a front and back server diagram](#lab-1-build-a-front-and-back-server-diagram)
  - [Lab 2: Create a server component glossary](#lab-2-create-a-server-component-glossary)
  - [Lab 3: Compare desktop and server hardware](#lab-3-compare-desktop-and-server-hardware)
  - [Lab 4: Build a VirtualBox server-style VM](#lab-4-build-a-virtualbox-server-style-vm)
  - [Lab 5: Practice boot order changes](#lab-5-practice-boot-order-changes)
  - [Lab 6: List disks and filesystems in Linux](#lab-6-list-disks-and-filesystems-in-linux)
  - [Lab 7: Simulate a disk disappearance](#lab-7-simulate-a-disk-disappearance)
  - [Lab 8: Complete a RAID reasoning worksheet](#lab-8-complete-a-raid-reasoning-worksheet)
  - [Lab 9: Create a boot-flow diagram](#lab-9-create-a-boot-flow-diagram)
  - [Lab 10: Build a BMC/iDRAC/iLO/IPMI notes page](#lab-10-build-a-bmcidraciloipmi-notes-page)
  - [Lab 11: Create an asset inventory example](#lab-11-create-an-asset-inventory-example)
  - [Lab 12: Hardware troubleshooting flowcharts](#lab-12-hardware-troubleshooting-flowcharts)
  - [Lab 13: Write mock hardware ticket updates](#lab-13-write-mock-hardware-ticket-updates)
  - [Lab 14: Build a Week 2 mock interview script](#lab-14-build-a-week-2-mock-interview-script)
  - [Lab 15: Final Week 2 self-assessment](#lab-15-final-week-2-self-assessment)
- [Part 4: Templates to copy into the portfolio](#part-4-templates-to-copy-into-the-portfolio)
  - [Asset inventory template](#asset-inventory-template)
  - [Hardware replacement checklist](#hardware-replacement-checklist)
  - [Boot troubleshooting checklist](#boot-troubleshooting-checklist)
  - [Disk replacement ticket template](#disk-replacement-ticket-template)
  - [No power investigation template](#no-power-investigation-template)
  - [RAID comparison template](#raid-comparison-template)
  - [Hardware handover template](#hardware-handover-template)
- [Part 5: Week 2 final exam](#part-5-week-2-final-exam)
  - [Written exam](#written-exam)
  - [Practical exam](#practical-exam)
  - [Passing standard](#passing-standard)
- [Part 6: Interview positioning for Week 2](#part-6-interview-positioning-for-week-2)
  - [Strong interview themes](#strong-interview-themes)
  - [Example answer: failed disk replacement](#example-answer-failed-disk-replacement)
  - [Example answer: no boot](#example-answer-no-boot)
  - [Example answer: iDRAC/iLO versus SSH](#example-answer-idracilo-versus-ssh)
- [Part 7: Week 2 completion checklist](#part-7-week-2-completion-checklist)
